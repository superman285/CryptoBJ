import contract from '../build/contracts/Dice2Win';
...
const utils = {
  ...
  getBalance() {
    this.tronWeb.trx.getBalance().then(function(balance) {
      return balance;
    });
  },

  placeBet(betMask, modulo, commitLastBlock, commit, r, s) {
    return this.contract.placeBet(betMask, modulo, commitLastBlock, r, s).call();
  }
